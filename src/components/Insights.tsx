...
export function Insights() {
  return (
    <div className="relative w-full max-w-7xl space-y-16 py-16 px-4 mx-auto pt-8">
      ...
      <InsightSection
        title="Прогнозы на 2027 год"
        description={
          <p>
            Модель предсказывает, что к 2027 году среднее время начала стримов сместится к <strong className="text-primary">14:44</strong>, а среднее количество зрителей вырастет до <strong className="text-primary">1900</strong>. Это говорит о долгосрочном росте и смещении графика на более позднее время.
          </p>
        }
        imgSrc="/images/olesha_long_term_forecast.png"
        imgAlt="Прогноз эволюции"
        reverse
      />
